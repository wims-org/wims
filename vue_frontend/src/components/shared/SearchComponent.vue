    ...
    <BRow align-v="center">
      <BCol>
        <BInputGroup class="borderless-input flex-nowrap">
          ...
          <BDropdown class="mt-2" align="end" @show="fetchQueries()">
            <BDropdownToggle>
...
const queries = ref<Query[]>([
  { _id: 'query3', name: 'Query 3', query: { "tag_uuid": "123e4567-e89b-12d3-a456-426614174000" }, description: null, created_at: null, updated_at: null },
])
