<template>
  <div class="container" ref="itemForm">
    ...
    <form v-if="item_org && formData_org">
      ...
      <button type="button" @click="handleSubmit" class="btn btn-primary mt-3">Submit</button>
    </form>
    <div v-else>
...
// State
const formData_org = ref<Record<string, unknown>>({});
const formData_new = ref<Record<string, unknown>>({});
